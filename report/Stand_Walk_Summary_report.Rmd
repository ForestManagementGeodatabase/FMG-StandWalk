...
# Determine if `stand_polys` are `Site` or `Stand`, then filter for 
# current stand.
if("SID" %in% colnames(params$stand_polys)) {
  ...
  health_st    <- dplyr::filter(params$health_summary, 
                                SID == params$stand_id)
  hlth_spec_st <- dplyr::filter(params$health_summary_species, 
                                SID == params$stand_id)
...
o1_dom_hlth_comp <- paste0(floor((filter(health_species_sort, 
...
o2_dom_hlth_comp <- paste0(floor((filter(health_species_sort, 
...
o3_dom_hlth_comp <- paste0(floor((filter(health_species_sort, 
...
o4_dom_hlth_comp <- paste0(floor((filter(health_species_sort, 
...
o5_dom_hlth_comp <- paste0(floor((filter(health_species_sort, 
...
:::
::: {.var-name}
Dominant Health Class Composition
:::
::: {.var-value}
`r o1_dom_hlth_comp`
:::
