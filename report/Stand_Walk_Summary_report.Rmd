...
## Match alpha hiearchy delimiter (p, c, u, t, s), then digits, 0 or more (\\d*)
...
# Simplify fixed_pts_st to just understory fields
...
fixed_understory <- dplyr::mutate_all(fixed_understory, list(~na_if(.,"")))
fixed_understory <- dplyr::mutate_all(fixed_understory, list(~na_if(.," ")))
fixed_understory <- dplyr::mutate_all(fixed_understory, list(~na_if(.,"<Null>")))
fixed_understory <- dplyr::mutate_all(fixed_understory, list(~na_if(.,"<NULL>")))
# Convert to long format by combining `UND_SP*` fields
